...
function optionsframework_add_page() {
	...
	if( version_compare( $wp_version, '3.8', '>=') ) {
		...
		$ico = $bloginfo_link . '/images/opt_.png' ;
	}
        ...
        <div id="header">
                ...
                <div id="header_right">
                        <div class="documentation">
                                Need help?  <a href="http://www.files.red-sun-design.com/redfolio/readme/readme.html#mytabs=3" target="_blank"> <?php _e('documentation', 'gxg_textdomain') ?> </a>
                        </div>
                </div>
...
function optionsframework_adminbar() {
        ...
        $wp_admin_bar->add_menu( array(
                'parent' => 'appearance',
                'id' => 'of_theme_options',
                'title' => __( 'red:folio Options', 'gxg_textdomain' ),
